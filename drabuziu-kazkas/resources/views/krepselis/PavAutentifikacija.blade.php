...
<head>
    ...
    <title></title>
    <!-- Include any necessary CSS styles or scripts -->
    <meta charset="UTF-8">
...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <h2 style="font-size: 1em;">Apmokėjimas sėkmingas</h2>

            
            <a class="btn btn-primary" href="{{ route('krepsys') }}">Atgal į krepšelį</a>
        </div>
    </div>
</div>
